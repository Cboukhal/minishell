...
# %bb.0:
	...
	movl	%edi, -4(%rbp)
.Ltmp2:
	.loc	1 102 13 prologue_end           # src/signal/handler.c:102:13
	movl	-4(%rbp), %eax
	.loc	1 102 11 is_stmt 0              # src/signal/handler.c:102:11
	movl	%eax, g_signal
	.loc	1 103 2 is_stmt 1               # src/signal/handler.c:103:2
...
# %bb.0:
	...
	movl	%edi, -4(%rbp)
.Ltmp4:
	.loc	1 108 13 prologue_end           # src/signal/handler.c:108:13
	movl	-4(%rbp), %eax
	.loc	1 108 11 is_stmt 0              # src/signal/handler.c:108:11
	movl	%eax, g_signal
	.loc	1 109 1 is_stmt 1               # src/signal/handler.c:109:1
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.Ltmp5:
