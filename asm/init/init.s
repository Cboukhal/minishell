	.text
	.file	"init.c"
	.file	1 "/mnt/nfs/homes/jbocktor/student/group_minishell/more_hope/minigroups" "src/init/../../include/minishell.h"
...
.Lfunc_begin0:
	.file	2 "/mnt/nfs/homes/jbocktor/student/group_minishell/more_hope/minigroups" "src/init/init.c"
...
.Linfo_string2:
	.asciz	"/mnt/nfs/homes/jbocktor/student/group_minishell/more_hope/minigroups" # string offset=54
.Linfo_string3:
	.asciz	"unsigned int"                  # string offset=123
.Linfo_string4:
	.asciz	"run"                           # string offset=136
.Linfo_string5:
	.asciz	"stop"                          # string offset=140
.Linfo_string6:
	.asciz	"success"                       # string offset=145
.Linfo_string7:
	.asciz	"failure"                       # string offset=153
.Linfo_string8:
	.asciz	"e_state"                       # string offset=161
.Linfo_string9:
	.asciz	"init_minishell_struct"         # string offset=169
.Linfo_string10:
	.asciz	"init_minishell"                # string offset=191
.Linfo_string11:
	.asciz	"minishell"                     # string offset=206
.Linfo_string12:
	.asciz	"dir"                           # string offset=216
.Linfo_string13:
	.asciz	"__dirstream"                   # string offset=220
.Linfo_string14:
	.asciz	"DIR"                           # string offset=232
.Linfo_string15:
	.asciz	"state"                         # string offset=236
.Linfo_string16:
	.asciz	"int"                           # string offset=242
.Linfo_string17:
	.asciz	"input"                         # string offset=246
.Linfo_string18:
	.asciz	"char"                          # string offset=252
.Linfo_string19:
	.asciz	"path"                          # string offset=257
.Linfo_string20:
	.asciz	"prompt"                        # string offset=262
.Linfo_string21:
	.asciz	"operator_nbr"                  # string offset=269
.Linfo_string22:
	.asciz	"exit_status"                   # string offset=282
.Linfo_string23:
	.asciz	"env_array"                     # string offset=294
.Linfo_string24:
	.asciz	"env"                           # string offset=304
.Linfo_string25:
	.asciz	"name"                          # string offset=308
.Linfo_string26:
	.asciz	"value"                         # string offset=313
.Linfo_string27:
	.asciz	"next"                          # string offset=319
.Linfo_string28:
	.asciz	"s_env"                         # string offset=324
.Linfo_string29:
	.asciz	"t_env"                         # string offset=330
.Linfo_string30:
	.asciz	"local"                         # string offset=336
.Linfo_string31:
	.asciz	"s_var"                         # string offset=342
.Linfo_string32:
	.asciz	"t_var"                         # string offset=348
.Linfo_string33:
	.asciz	"syntax_tree"                   # string offset=354
.Linfo_string34:
	.asciz	"node"                          # string offset=366
.Linfo_string35:
	.asciz	"id"                            # string offset=371
.Linfo_string36:
	.asciz	"type"                          # string offset=374
.Linfo_string37:
	.asciz	"pipe_fd"                       # string offset=379
.Linfo_string38:
	.asciz	"left"                          # string offset=387
.Linfo_string39:
	.asciz	"pid"                           # string offset=392
.Linfo_string40:
	.asciz	"wstatus"                       # string offset=396
.Linfo_string41:
	.asciz	"arg"                           # string offset=404
.Linfo_string42:
	.asciz	"s_arg"                         # string offset=408
.Linfo_string43:
	.asciz	"t_arg"                         # string offset=414
.Linfo_string44:
	.asciz	"pipe"                          # string offset=420
.Linfo_string45:
	.asciz	"to_close"                      # string offset=425
.Linfo_string46:
	.asciz	"write"                         # string offset=434
.Linfo_string47:
	.asciz	"read"                          # string offset=440
.Linfo_string48:
	.asciz	"s_pipe"                        # string offset=445
.Linfo_string49:
	.asciz	"t_pipe"                        # string offset=452
.Linfo_string50:
	.asciz	"redir"                         # string offset=459
.Linfo_string51:
	.asciz	"in_fd"                         # string offset=465
.Linfo_string52:
	.asciz	"out_fd"                        # string offset=471
.Linfo_string53:
	.asciz	"infile"                        # string offset=478
.Linfo_string54:
	.asciz	"fd"                            # string offset=485
.Linfo_string55:
...
.Linfo_string96:
	.asciz	"__uid_t"                       # string offset=863
.Linfo_string97:
	.asciz	"_timer"                        # string offset=871
.Linfo_string98:
	.asciz	"si_tid"                        # string offset=878
.Linfo_string99:
	.asciz	"si_overrun"                    # string offset=885
.Linfo_string100:
	.asciz	"si_sigval"                     # string offset=896
.Linfo_string101:
	.asciz	"sival_int"                     # string offset=906
.Linfo_string102:
	.asciz	"sival_ptr"                     # string offset=916
.Linfo_string103:
	.asciz	"sigval"                        # string offset=926
.Linfo_string104:
	.asciz	"__sigval_t"                    # string offset=933
.Linfo_string105:
	.asciz	"_rt"                           # string offset=944
.Linfo_string106:
	.asciz	"_sigchld"                      # string offset=948
.Linfo_string107:
	.asciz	"si_status"                     # string offset=957
.Linfo_string108:
	.asciz	"si_utime"                      # string offset=967
.Linfo_string109:
	.asciz	"long int"                      # string offset=976
.Linfo_string110:
	.asciz	"__clock_t"                     # string offset=985
.Linfo_string111:
	.asciz	"si_stime"                      # string offset=995
.Linfo_string112:
	.asciz	"_sigfault"                     # string offset=1004
.Linfo_string113:
	.asciz	"si_addr"                       # string offset=1014
.Linfo_string114:
	.asciz	"si_addr_lsb"                   # string offset=1022
.Linfo_string115:
	.asciz	"short"                         # string offset=1034
.Linfo_string116:
	.asciz	"_bounds"                       # string offset=1040
.Linfo_string117:
	.asciz	"_addr_bnd"                     # string offset=1048
.Linfo_string118:
	.asciz	"_lower"                        # string offset=1058
.Linfo_string119:
	.asciz	"_upper"                        # string offset=1065
.Linfo_string120:
	.asciz	"_pkey"                         # string offset=1072
.Linfo_string121:
	.asciz	"__uint32_t"                    # string offset=1078
.Linfo_string122:
	.asciz	"_sigpoll"                      # string offset=1089
.Linfo_string123:
	.asciz	"si_band"                       # string offset=1098
.Linfo_string124:
	.asciz	"si_fd"                         # string offset=1106
.Linfo_string125:
	.asciz	"_sigsys"                       # string offset=1112
.Linfo_string126:
	.asciz	"_call_addr"                    # string offset=1120
.Linfo_string127:
	.asciz	"_syscall"                      # string offset=1131
.Linfo_string128:
	.asciz	"_arch"                         # string offset=1140
.Linfo_string129:
	.asciz	"siginfo_t"                     # string offset=1146
.Linfo_string130:
	.asciz	"sa_mask"                       # string offset=1156
.Linfo_string131:
	.asciz	"__val"                         # string offset=1164
.Linfo_string132:
	.asciz	"long unsigned int"             # string offset=1170
.Linfo_string133:
	.asciz	"__sigset_t"                    # string offset=1188
.Linfo_string134:
	.asciz	"sa_flags"                      # string offset=1199
.Linfo_string135:
	.asciz	"sa_restorer"                   # string offset=1208
.Linfo_string136:
	.asciz	"sigaction"                     # string offset=1220
.Linfo_string137:
	.asciz	"statbuf"                       # string offset=1230
.Linfo_string138:
	.asciz	"st_dev"                        # string offset=1238
.Linfo_string139:
	.asciz	"__dev_t"                       # string offset=1245
.Linfo_string140:
	.asciz	"st_ino"                        # string offset=1253
.Linfo_string141:
	.asciz	"__ino_t"                       # string offset=1260
.Linfo_string142:
	.asciz	"st_nlink"                      # string offset=1268
.Linfo_string143:
	.asciz	"__nlink_t"                     # string offset=1277
.Linfo_string144:
	.asciz	"st_mode"                       # string offset=1287
.Linfo_string145:
	.asciz	"__mode_t"                      # string offset=1295
.Linfo_string146:
	.asciz	"st_uid"                        # string offset=1304
.Linfo_string147:
	.asciz	"st_gid"                        # string offset=1311
.Linfo_string148:
	.asciz	"__gid_t"                       # string offset=1318
.Linfo_string149:
	.asciz	"st_rdev"                       # string offset=1326
.Linfo_string150:
	.asciz	"st_size"                       # string offset=1334
.Linfo_string151:
	.asciz	"__off_t"                       # string offset=1342
.Linfo_string152:
	.asciz	"st_blksize"                    # string offset=1350
.Linfo_string153:
	.asciz	"__blksize_t"                   # string offset=1361
.Linfo_string154:
	.asciz	"st_blocks"                     # string offset=1373
.Linfo_string155:
	.asciz	"__blkcnt_t"                    # string offset=1383
.Linfo_string156:
	.asciz	"st_atim"                       # string offset=1394
.Linfo_string157:
	.asciz	"tv_sec"                        # string offset=1402
.Linfo_string158:
	.asciz	"__time_t"                      # string offset=1409
.Linfo_string159:
	.asciz	"tv_nsec"                       # string offset=1418
.Linfo_string160:
	.asciz	"__syscall_slong_t"             # string offset=1426
.Linfo_string161:
	.asciz	"timespec"                      # string offset=1444
.Linfo_string162:
	.asciz	"st_mtim"                       # string offset=1453
.Linfo_string163:
	.asciz	"st_ctim"                       # string offset=1461
.Linfo_string164:
	.asciz	"__glibc_reserved"              # string offset=1469
.Linfo_string165:
	.asciz	"stat"                          # string offset=1486
.Linfo_string166:
	.asciz	"term"                          # string offset=1491
.Linfo_string167:
	.asciz	"c_iflag"                       # string offset=1496
.Linfo_string168:
	.asciz	"tcflag_t"                      # string offset=1504
.Linfo_string169:
	.asciz	"c_oflag"                       # string offset=1513
.Linfo_string170:
	.asciz	"c_cflag"                       # string offset=1521
.Linfo_string171:
	.asciz	"c_lflag"                       # string offset=1529
.Linfo_string172:
	.asciz	"c_line"                        # string offset=1537
.Linfo_string173:
	.asciz	"unsigned char"                 # string offset=1544
.Linfo_string174:
	.asciz	"cc_t"                          # string offset=1558
.Linfo_string175:
	.asciz	"c_cc"                          # string offset=1563
.Linfo_string176:
	.asciz	"c_ispeed"                      # string offset=1568
.Linfo_string177:
	.asciz	"speed_t"                       # string offset=1577
.Linfo_string178:
	.asciz	"c_ospeed"                      # string offset=1585
.Linfo_string179:
	.asciz	"termios"                       # string offset=1594
.Linfo_string180:
	.asciz	"s_minishell"                   # string offset=1602
.Linfo_string181:
	.asciz	"t_minishell"                   # string offset=1614
.Linfo_string182:
	.asciz	"envp"                          # string offset=1626
