# 1 "src/parsing/command_redir_outfile.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/parsing/command_redir_outfile.c" 2
# 13 "src/parsing/command_redir_outfile.c"
...
# 14 "src/parsing/command_redir_outfile.c" 2
