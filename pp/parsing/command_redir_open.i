# 1 "src/parsing/command_redir_open.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/parsing/command_redir_open.c" 2
# 13 "src/parsing/command_redir_open.c"
# 1 "src/parsing/../../include/minishell.h" 1
# 16 "src/parsing/../../include/minishell.h"
...
# 17 "src/parsing/../../include/minishell.h" 2
...
# 18 "src/parsing/../../include/minishell.h" 2
...
# 19 "src/parsing/../../include/minishell.h" 2
...
# 21 "src/parsing/../../include/minishell.h" 2
...
extern __pid_t wait4 (__pid_t __pid, int *__stat_loc, int __options,
        struct rusage *__usage) __attribute__ ((__nothrow__));
# 22 "src/parsing/../../include/minishell.h" 2
# 1 "/usr/lib/llvm-12/lib/clang/12.0.1/include/stdbool.h" 1 3
# 23 "src/parsing/../../include/minishell.h" 2
...
# 24 "src/parsing/../../include/minishell.h" 2
...
# 28 "src/parsing/../../include/minishell.h" 2
# 1 "/usr/lib/llvm-12/lib/clang/12.0.1/include/limits.h" 1 3
# 29 "src/parsing/../../include/minishell.h" 2
# 1 "src/parsing/../../include/colors.h" 1
# 30 "src/parsing/../../include/minishell.h" 2
...
# 32 "src/parsing/../../include/minishell.h" 2
...
# 34 "src/parsing/../../include/minishell.h" 2
...
# 14 "src/parsing/command_redir_open.c" 2
...
int open_command_infile(t_cmd *cmd)
{
 ...
 if (index->type == heredoc)
  in_fd = open("/tmp/heredoc", 00);
 else
  in_fd = open(index->name, 00);
 return (in_fd);
}
...
int open_command_outfile(t_cmd *cmd)
{
 ...
 while (index)
 {
  if (index->type == outfile)
   out_fd = open(index->name, 0100 | 01 | 01000,
     0400 | 0200 | (0400 >> 3) | ((0400 >> 3) >> 3));
  else if (index->type == append)
   out_fd = open(index->name, 0100 | 01 | 02000,
     0400 | 0200 | (0400 >> 3) | ((0400 >> 3) >> 3));
  if (index->next == ((void*)0))
   break ;
  else
...
void backup_in_out(t_backup *std_in_out)
{
 std_in_out->stdin_backup = dup(0);
 std_in_out->stdout_backup = dup(1);
}
...
{
 if (cmd->redir->infile)
  dup2(std_in_out->stdin_backup , 0);
 if (cmd->redir->outfile)
  dup2(std_in_out->stdout_backup, 1);
}
