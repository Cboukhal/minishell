# 1 "src/parsing/command_arguments.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/parsing/command_arguments.c" 2
# 13 "src/parsing/command_arguments.c"
...
# 14 "src/parsing/command_arguments.c" 2
...
char **get_command_arg_array(t_arg *arg)
{
 ...
 if (!arg_array)
  return (perror("arg_array"), ((void*)0));
 while (i < length)
 {
