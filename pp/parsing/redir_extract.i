# 1 "src/parsing/redir_extract.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/parsing/redir_extract.c" 2
# 13 "src/parsing/redir_extract.c"
...
# 14 "src/parsing/redir_extract.c" 2
...
void get_redir_heredoc(char *delimiter)
{
 ...
 fd = open("/tmp/heredoc", 01 | 01000 | 0100, 0400 | 0200);
 while (1)
 {
  write(1, "> ", 2);
...
# 71 "src/parsing/redir_extract.c"
void add_infile_to_list(t_infile **infile, t_infile **new)
{
 t_infile *index;
