# 1 "src/parsing/command_redir_utils.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/parsing/command_redir_utils.c" 2
# 13 "src/parsing/command_redir_utils.c"
...
# 14 "src/parsing/command_redir_utils.c" 2
...
int get_redir_filename_length(char *lexeme, int type, int *start)
{
 ...
 if (type == heredoc || type == append)
  ...
  i = 1;
 while (lexeme[i] && is_blank(lexeme[i]) == 1)
  i++;
 *start = i;
 length = 0;
 while (lexeme[i])
