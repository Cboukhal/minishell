# 1 "src/parsing/syntax_tree.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/parsing/syntax_tree.c" 2
# 13 "src/parsing/syntax_tree.c"
...
# 14 "src/parsing/syntax_tree.c" 2
...
t_ast *get_syntax_tree(t_minishell *minishell)
{
 ...
 root = ((void*)0);
 token = minishell->token_stream;
 while (i < minishell->operator_nbr && (*__errno_location ()) == 0)
 {
