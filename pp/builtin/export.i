# 1 "src/builtin/export.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/builtin/export.c" 2
# 13 "src/builtin/export.c"
...
# 14 "src/builtin/export.c" 2
# 31 "src/builtin/export.c"
...
_Bool is_valid_variable(t_minishell *minishell, char *arg)
{
 int i;
...
t_env *parse_export_arg(t_minishell *minishell, char **arg_array)
{
 ...
 i = 0;
 export_arg = ((void*)0);
 while (arg_array[i] && (*__errno_location ()) == 0)
 {
