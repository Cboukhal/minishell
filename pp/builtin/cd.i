...
# 14 "src/builtin/cd.c" 2
# 52 "src/builtin/cd.c"
_Bool got_too_much_arg(char **arg_array)
{
 int i;
...
void cd_home(t_minishell *minishell)
{
 ...
 if (!home)
  error_cd(1, ((void*)0), &minishell->exit_status);
...
void cd(t_minishell *minishell, t_cmd *cmd)
{
 if (got_too_much_arg(cmd->arg_array))
  error_cd(2, ((void*)0), &minishell->exit_status);
