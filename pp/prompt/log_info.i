# 1 "src/prompt/log_info.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/prompt/log_info.c" 2
# 13 "src/prompt/log_info.c"
...
char *set_log_info_colors(char *log_info)
{
 ...
 tmp = ft_strjoin("\1\033[1m\2" "\1\033[32m\2", log_info);
 log_info_colorized = ft_strjoin(tmp, "\1\033[0m\2");
 free(log_info);
 free(tmp);
