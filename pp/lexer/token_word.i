# 1 "src/lexer/token_word.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/lexer/token_word.c" 2
# 13 "src/lexer/token_word.c"
...
_Bool is_empty_within_two_quote(int length, int quote_nbr)
{
...
void get_word_token(char *input, t_token **new)
{
 ...
 if ((*__errno_location ()) == 0 && (*new)->quote_nbr != -1)
 {
