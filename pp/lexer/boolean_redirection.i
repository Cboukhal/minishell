# 1 "src/lexer/boolean_redirection.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/lexer/boolean_redirection.c" 2
# 13 "src/lexer/boolean_redirection.c"
...
# 14 "src/lexer/boolean_redirection.c" 2
...
_Bool got_filename(char *lexeme, int type)
{
 ...
 while (lexeme[i])
 {
  if (is_blank(lexeme[i]) == 0)
   return (1);
  i++;
 }
 (*__errno_location ()) = error_file;
 return (0);
}
